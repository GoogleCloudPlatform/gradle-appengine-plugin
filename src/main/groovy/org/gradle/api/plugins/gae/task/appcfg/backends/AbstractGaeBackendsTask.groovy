...
/**
 * Abstract Google App Engine task for handling backends.
 *
 * @author Benjamin Muschko
 */
abstract class AbstractGaeBackendsTask extends GaeAppConfigTaskTemplate {
    static final String COMMAND = 'backends'
